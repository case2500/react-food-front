                        ...
                        currentItems.map((p, index) => (
                            <tr className="px-2 bg-gray-100 border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td className="w-32 mx-auto text-xl ">
                                    <img src={`${imageUrl}/uploads/products/${p.image}`} />
                                </td>
                                <td className="w-72 mx-auto text-xl ">{p.name}</td>
                                <td className="w-16 px-1  text-xl text-right ">{currencyFormat(p.price)}</td>
                                <td className="w-64 px-1  text-xl text-center">{p.stock}</td>
                                <td className="px-1  text-xl w-96">
